...
def create_campaign(client: GoogleAdsClient, customer_id: str, campaign_name: str, 
    ...
    try:
        ...
        # In API v20, geo targeting is handled differently
        # The geo targeting settings are controlled by other campaign settings
        # rather than a separate GeoTargetTypeSetting object
    ...
    try:
        ...
        for account_name, account_data in all_accounts_keywords.items():
            ...
            for campaign_id, campaign_data in account_data['campaigns'].items():
                ...
                if top_keywords:
                    # Fix: Calculate CTR using total campaign metrics, not average of keyword CTRs
