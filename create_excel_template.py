...
def create_excel_template():
    ...
    sample_data = {
        ...
        'path1': ['services', 'consulting', 'contact'],
        'path2': ['', '', ''],
    ...
    instructions = [
        ...
        ["• path1 - First display URL path (e.g., services, contact, about)"],
        ["• path2 - Second display URL path (optional, e.g., quote, info)"],
        ...
        [""],
        ["URL CONSTRUCTION:"],
        ["• Final URL = final_url (actual landing page)"],
        ["• Display URL = final_url + /path1 + /path2 (what users see in ads)"],
        ["• Example: final_url='https://ppcl.com' + path1='services' = display URL 'https://ppcl.com/services'"],
        ["• Path1 and Path2 are for display only and don't affect the actual landing page"],
        [""],
        ["IMPORTANT NOTES:"],
