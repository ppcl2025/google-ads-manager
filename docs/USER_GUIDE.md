...
- 🔍 **Keyword Research** - Analyze competition, search volume, and discover new opportunities
...
- Keyword Planner data (competition, search volume, suggested bids)
...
**Purpose:** Analyze keyword competition, search volume, and discover new opportunities using Google Keyword Planner data.

**How to Use:**

1. **Select Account & Campaign (Optional)**
   - Choose account from dropdown
   - Optionally select a campaign to extract keywords from
   - Campaign selection enables geo-targeted Keyword Planner data

2. **Choose Analysis Mode**
   - **📋 Use Keywords from Campaign:** Automatically extracts keywords from selected campaign
   - **✏️ Enter Keywords Manually:** Type keywords one per line

3. **Set Analysis Options**
   - **🤖 Get AI Recommendations:** Get Claude's analysis and expansion recommendations (default: ON)
   - **🔗 Show Related Keywords:** Display keyword suggestions from Google (default: ON)

4. **Run Analysis**
   - Click "🚀 Analyze Keywords"
   - Wait for 3 steps:
     - Step 1: Fetching Keyword Planner data from Google Ads API
     - Step 2: Formatting keyword data
     - Step 3: Claude analysis (if enabled)

5. **Review Results**
   - **Keyword Planner Results Table:** Shows competition, search volume, and suggested bid ranges
   - **Related Keyword Opportunities:** Top 20 keyword suggestions from Google
   - **AI Recommendations:** Claude's analysis including:
...
- Suggested bid ranges from Google
- Related keyword opportunities
- AI-powered expansion recommendations
- Quality Score problem identification
- Market positioning analysis

**Tips:**
- Use campaign selection for geo-targeted data (more accurate for local markets)
- Focus on LOW competition keywords for better opportunities
- Watch for Quality Score issues (CPC 2x+ suggested bid = QS problem)
- Prioritize high-intent keywords (motivated seller language)
- Review related keywords for expansion opportunities

**When to Use:**
- Before launching new campaigns
- When expanding keyword lists
- To identify competition issues
- To find low-competition opportunities
- To assess market positioning
